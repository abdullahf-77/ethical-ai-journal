...
export function TaxonomyOrb({ dimmed }: { dimmed: boolean }) {
  return (
    ...
    >
      <div className="relative flex size-[104px] items-center justify-center sm:size-[128px]">
        <div
          className="absolute inset-[-46px] rounded-full blur-2xl"
          style={{ background: "radial-gradient(closest-side, rgba(0,122,51,0.30), transparent)" }}
          aria-hidden="true"
        />
        <div
          className="absolute inset-[-46px] hidden rounded-full blur-2xl dark:block"
          style={{ background: "radial-gradient(closest-side, rgba(107,183,94,0.35), transparent)" }}
          aria-hidden="true"
        />

        <div className="absolute inset-[-20px] rounded-full border border-icaire-700/15 dark:border-icaire-300/12" aria-hidden="true" />
        <div className="absolute inset-[-38px] rounded-full border border-icaire-700/8 dark:border-icaire-300/6" aria-hidden="true" />
        ...
        >
          ...
          <div className="relative">
            <p className="text-[9px] font-semibold uppercase tracking-[0.22em] text-white/95 sm:text-[10px]">
              Ethical AI
            </p>
            <p className="text-[9px] font-semibold uppercase tracking-[0.22em] text-white/95 sm:text-[10px]">
              Taxonomy
